...
public class StreamDescription extends IStreamDescription {
    ...
    public static StreamDescription parseJson(JSONObject streamObj,boolean isLocal) {
        ...
        if (attr != null) {
            connectionId = attr.optString("connectionId");
            erizoId = attr.optString("erizoId");
        }

        return new StreamDescription(id, data, video, audio, screen, attr,label, connectionId,erizoId,isLocal);
    }

    public StreamDescription(long id, boolean data, boolean video, boolean audio, String screen, JSONObject attr, String label, String connectionId,String erizoId, boolean isLocal) {
        mId = id;
        mData = data;
        mVideo = video;
        mAudio = audio;
