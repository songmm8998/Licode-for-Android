...
public class MainActivity extends AppCompatActivity {
    ...
    private String mTokenServerUrl = "https://topber.com.cn:3004/createToken/";
    ...
    private void initData(String encodeToken, String token) {
        ...
        try {
            ...
            try {
                ...
                String encodeToken1 = URLEncoder.encode(tokenId, "UTF-8");
                host = host + "?tokenId=" + encodeToken1 + "&signature=" + encodeSig + "&host=" + encodeHost;
            } catch (UnsupportedEncodingException e) {

            }
            mRoomConnectionParameters = new LicodeSignalingService.RoomConnectionParameters(encodeToken, token, host, tokenId, secure, signature);
