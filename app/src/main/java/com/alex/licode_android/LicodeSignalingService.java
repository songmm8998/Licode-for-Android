...
public interface LicodeSignalingService {
    ...
    class RoomConnectionParameters {
        ...
        public RoomConnectionParameters(String encodeToken,String token,String host, String tokenId, boolean secure, String signature) {
            this.token = token;
            this.host = host;
        ...
        public RoomConnectionParameters(String token) {
            this(null,token, null, null, false ,null/* urlParameters */);
        }
    }
    ...
    interface SignalingEvents {
         ...
         */
        void onRemoteDescription(final String connectionId, final String sdp);
